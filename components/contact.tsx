  ...
  return (
    <section id="contact" className="mb-20 sm:mb-28 w-[min(100%,38rem)] text-center">
        ...
        <form className="mt-10 flex flex-col">
            ...
            <button className="bg-sky-500 hover:bg-sky-700 text-white px-7 py-3 flex items-center gap-2 rounded-full h-[3rem] w-[8rem]" type="submit" >Send <FaPaperPlane /></button>
        </form>
    </section>
  )
}
